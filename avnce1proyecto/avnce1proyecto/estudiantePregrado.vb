Public Class estudiantePregrado
    ...
    Public Sub New(id As Integer, nombre As String, apellido As String, direccion As String, correo As String, num_matricula As Integer, carrera As String, cantidad_ventas As Integer)
