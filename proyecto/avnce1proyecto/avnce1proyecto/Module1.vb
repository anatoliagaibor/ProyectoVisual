...
Module Module1
    ...
    Sub Main()
        ...
        Dim pathW As String = "..\..\inventario.xml"
            ...
            Case 1
                ...
                Select Case item
                    Case 1
                        ...
                        xmlDoc.Load(path)
                        Dim listaAdministradores As ArrayList = New ArrayList
                        ...
                        For Each usu As XmlNode In personas
                            If usu.Attributes(0).Value = "si" Then
                                If usu.Attributes(1).Value = usuario And usu.Attributes(2).Value = clave Then
                                    validador = True
                        ...
                        If validador = True Then
                            persona = New Persona()
                            persona.menuAdmnistrador()

                        Else
                            Console.WriteLine("ingreso mal los datos hola ")
                            Console.ReadLine()
                        End If
